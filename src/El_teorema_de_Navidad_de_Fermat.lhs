% El_teorema_de_Navidad_de_Fermat.lhs
...
El \href{http://bit.ly/2Roso1o}{teorema de Navidad de Fermat} que afirma que  
un número primo impar p se puede escribir exactamente de una manera
como suma de dos cuadrados de números naturales \(p = x^2 + y^2\) (con
\(x \leq y\)) si, y sólo si, p se puede escribir como uno más un múltiplo
de 4 (es decir, que son congruentes con 1 módulo 4).

Comprobar con QuickCheck el torema de Navidad de Fermat; es decir,
