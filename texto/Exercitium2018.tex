...
\title{
  ...
  {\normalsize (hasta el 29 de marzo de 2019)}}} }  
...
\subsection*{Versión del 30 de marzo de 2019}

Se han añadido los ejercicios resueltos del 18 al 22 de marzo: 
...
\subsection*{Versión del 6 de abril de 2019}

Se han añadido los ejercicios resueltos del 25 al 29 de marzo: 
...
\chapter{Permutación de elementos consecutivos}
\label{190318}
\entrada{Permutacion_de_consecutivos}

\chapter{Caminos minimales en un árbol numérico}
\label{190319}
\entrada{Caminos_minimales_en_un_arbol_numerico}

\chapter{Siguiente mayor}
\label{190320}
\entrada{Siguiente_mayor}

\chapter{La sucesión ECG}
\label{190321}
\entrada{La_sucesion_ECG}

\chapter{Matriz de mínimas distancias}
\label{190322}
\entrada{Matriz_de_minimas_distancias}

% ------------------------------------------------------------------------------

\chapter{El problema del número perdido}
\label{190325}
\entrada{El_problema_del_numero_perdido}

\chapter{Árboles cuyas ramas cumplen una propiedad}
\label{190326}
\entrada{Arboles_cuyas_ramas_cumplen_una_propiedad}

\chapter{Matriz girada 180 grados}
\label{190327}
\entrada{Matriz_girada_180_grados}

\chapter{Subconjuntos divisibles}
\label{190328}
\entrada{Subconjuntos_divisibles}

\chapter{Triángulo de Euler}
\label{190329}
\entrada{Triangulo_de_Euler}
